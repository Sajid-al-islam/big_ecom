                        ...
                        <div class="product-detail-thumb me-lg-6">
                            <div class="swiper single-product-thumb-slider">
                                <div class="swiper-wrapper">
                                    <a href="#" class="lightbox-image swiper-slide" data-fancybox="gallery">
                                        <img id="preview_pro" src="{{ $product->related_images[0]['image_link'] }}" width="640" height="530" alt="Image-Ctgcomputer">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex gap-2">
                            @foreach ($product->related_images as $item)
                                <img src="{{ $item['image_link'] }}" onclick="document.getElementById('preview_pro').src=event.target.src" class="img-thumbnail" style="cursor:pointer;" width="120px"  alt="">
                            @endforeach
                        </div>
                    </div>
                    <div class="col-lg-6">
